...
from my_triangle import classify_triangle
...
class TestTriangles(unittest.TestCase):
    ...
    def testScaleneRightTriangleA(self): 
        ...
        self.assertEqual(classify_triangle(3, 4, 5),'Scalene Right','3, 4, 5 is a Scalene Right triangle')
    def testScaleneRightTriangleB(self):
        ...
        self.assertEqual(classify_triangle(3, 5, 4),'Scalene Right','3, 5, 4 is a Scalene Right triangle')
    def testScaleneRightTriangleC(self):
        ...
        self.assertEqual(classify_triangle(4, 3, 5),'Scalene Right','4, 3, 5 is a Scalene Right triangle')
    def testScaleneRightTriangleD(self):
        ...
        self.assertEqual(classify_triangle(4, 5, 3),'Scalene Right','4, 5, 3 is a Scalene Right triangle')
    def testScaleneRightTriangleE(self):
        ...
        self.assertEqual(classify_triangle(5, 3, 4),'Scalene Right','5, 3, 4 is a Scalene Right triangle')
    def testScaleneRightTriangleF(self):
        ...
        self.assertEqual(classify_triangle(5, 4, 3),'Scalene Right','5, 4, 3 is a Scalene Right triangle')
    ...
    def testIsoscelesTriangleA(self):
        ...
        self.assertEqual(classify_triangle(20, 20, 25), 'Isosceles', '20, 20, 25 should be an Isosceles triangle')
    def testIsoscelesTriangleB(self):
        """Strictly isosceles. Test side order B."""
        self.assertEqual(classify_triangle(20, 25, 20), 'Isosceles', '20, 25, 20 should be an Isosceles triangle')
    def testIsoscelesTriangleC(self):
        """Strictly isosceles. Test side order C."""
        self.assertEqual(classify_triangle(25, 20, 20), 'Isosceles', '25, 20, 20 should be an Isosceles triangle')
        
        
    def testScaleneTriangleA(self):
        """Strictly scalene. Test side order A."""
        self.assertEqual(classify_triangle(89, 112, 114),'Scalene', '89, 112, 114 should be a Scalene triangle')
    def testScaleneTriangleB(self):
        """Strictly scalene. Test side order B."""
        self.assertEqual(classify_triangle(89, 114, 112),'Scalene', '89, 114, 112 should be a Scalene triangle')
    def testScaleneTriangleC(self):
        """Strictly scalene. Test side order C."""
        self.assertEqual(classify_triangle(112, 89, 114),'Scalene', '112, 89, 114 should be a Scalene triangle')
    def testScaleneTriangleD(self):
        """Strictly scalene. Test side order D."""
        self.assertEqual(classify_triangle(112, 114, 89),'Scalene', '112, 114, 89 should be a Scalene triangle')
    def testScaleneTriangleE(self):
        """Strictly scalene. Test side order E."""
        self.assertEqual(classify_triangle(114, 89, 112),'Scalene', '114, 89, 112 should be a Scalene triangle')
    def testScaleneTriangleF(self):
        """Strictly scalene. Test side order F."""
        self.assertEqual(classify_triangle(114, 112, 89),'Scalene', '114, 112, 89 should be a Scalene triangle')
        
        
    def testBadTriangleA(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order A."""
        self.assertEqual(classify_triangle(1, 2, 5), "NotATriangle", "1, 2, 5 side lengths cannot form a triangle")
    def testBadTriangleB(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order B."""
        self.assertEqual(classify_triangle(1, 5, 2), "NotATriangle", "1, 5, 2 side lengths cannot form a triangle")
    def testBadTriangleC(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order C."""
        self.assertEqual(classify_triangle(2, 1, 5), "NotATriangle", "2, 1, 5 side lengths cannot form a triangle")
    def testBadTriangleD(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order D."""
        self.assertEqual(classify_triangle(2, 5, 1), "NotATriangle", "2, 5, 1 side lengths cannot form a triangle")
    def testBadTriangleE(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order E."""
        self.assertEqual(classify_triangle(5, 1, 2), "NotATriangle", "5, 1, 2 side lengths cannot form a triangle")
    def testBadTriangleF(self):
        """Test inputs that do not satisfy the Triangle Inequality Theorem. Test side order F."""
        self.assertEqual(classify_triangle(5, 2, 1), "NotATriangle", "5, 2, 1 side lengths cannot form a triangle")
        
        
    def testInvalInputA(self):
        """Test inputs that do not satisfy the bounds placed on the inputs. One invalid input > 200."""
        self.assertEqual(classify_triangle(201, 100, 120), "InvalidInput", "201 is an invalid input")
    ...
    def testInvalInputG(self):
        ...
        self.assertEqual(classify_triangle(-12, 400, 0), "InvalidInput", "-12, 400, and 0 are invalid inputs")
    def testInvalInputH(self):
        ...
        self.assertEqual(classify_triangle(-4, 17, 201), "InvalidInput", "-4 and 201 are invalid inputs")
    ...
    def testDecimalInputsA(self):
        ...
        self.assertEqual(classify_triangle(20.5, 30, 40), "InvalidInput", "20.5 is an invalid input")
    def testDecimalInputsB(self):
        ...
        self.assertEqual(classify_triangle(20.5, 20.5, 40), "InvalidInput", "20.5 and 20.5 are invalid inputs")
    def testDecimalInputsC(self):
        ...
        self.assertEqual(classify_triangle(20.5, 20.5, 20.5), "InvalidInput", "20.5, 20.5, 20.5 are invalid inputs")

if __name__ == '__main__':
    print('Running unit tests')
    unittest.main()
    
# Adding comment to attempt to fix Travis error    
